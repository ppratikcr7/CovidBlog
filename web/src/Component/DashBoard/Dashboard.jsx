                        ...
                        <div class="w-7/8 p-3 pl-0">
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <p class="mb-6">My first tweet for my covid blogging website!!</p>

                                </div>
                            </div>

                            <div class="pb-2">
                                <span class="mr-8"><a href="#" class="text-grey-dark hover:no-underline hover:text-red"><i class="fa fa-heart fa-lg mr-2"></i> 1</a></span>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex border border-solid border-grey rounded">
                                        ...
                                        <div class="w-3/4 p-3">
                                            ...
                                            <p class="mb-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus voluptate tempore itaque culpa hic qui nostrum, minus harum cupiditate a voluptatibus.</p>
